...
| `ubi.repo` | Yum repo definitions for UBI 10 (referenced by `rpms.in.yaml`) |
...
`/cachi2/cachi2.env` file that redirects pip and dnf/microdnf to use the
prefetched dependencies.

## Regenerating the RPM Lockfile

When you add/remove RPM packages in `rpms.in.yaml` or update `ubi.repo`, you
